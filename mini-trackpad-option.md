...
[build.yaml](https://github.com/sekigon-gonnoc/zmk-keyboard-torabo-tsuki-lp/blob/master/build.yaml)を編集し、トラックボール側のスニペットに`input-split-listener`、トラックパッド側のスニペットに`input-trackpad-mini`と`input-split`を追加してビルド
