...
### (V2の場合)電池ボックスをはんだ付けする

* 電池ボックスのピンを折り曲げます。なるべくピンが真上に向くように折り曲げていきます。手で90度まで曲げても手を離すと手前まで戻ってしまうので、以下のような手順で進めてください。
  ![](img/v2-box-pin.jpg)
  1. 電池ボックスのピン先端をつかみ、真横を向くように曲げます。手を離すと下に少し戻るので、様子を見ながら少しずつ曲げ量を増やします。
